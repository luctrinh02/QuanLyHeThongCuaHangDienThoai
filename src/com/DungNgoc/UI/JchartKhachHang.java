 ...
 * @author Admin
 */
public class JchartKhachHang extends javax.swing.JDialog {
    thongKeKhachHangDAO tk=new thongKeKhachHangDAO();
    /**
     * Creates new form JchartKhachHang
     */
    public JchartKhachHang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(750, 400);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JchartKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JchartKhachHang dialog = new JchartKhachHang(new javax.swing.JFrame(), true);
