 ...
 * @author Admin
 */
public class JchartSanPham extends javax.swing.JDialog {
    ThongKeSanPhamDAO sp=new ThongKeSanPhamDAO();
    /** Creates new form JchartSanPham */
    public JchartSanPham(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(750, 400);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JchartSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JchartSanPham dialog = new JchartSanPham(new javax.swing.JFrame(), true);
