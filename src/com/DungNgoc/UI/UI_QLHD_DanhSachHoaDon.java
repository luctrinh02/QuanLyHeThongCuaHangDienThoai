 ...
 * @author FPTSHOP
 */
public class UI_QLHD_DanhSachHoaDon extends javax.swing.JDialog {

    /**
     * Creates new form UI_QLHD_DanhSachHoaDon
     */
    public UI_QLHD_DanhSachHoaDon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_QLHD_DanhSachHoaDon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UI_QLHD_DanhSachHoaDon dialog = new UI_QLHD_DanhSachHoaDon(new javax.swing.JFrame(), true);
